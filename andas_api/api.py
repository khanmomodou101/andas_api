...
def get_all_branch_data():
    ...
    try:
        return {
            ...
            "sales_transactions": get_sales_transactions(),
            "stock_adjustment": get_stock_adjustment(),
            "wastages": get_wastages(),
...
def get_comprehensive_report():
    ...
    try:
        report = {
            ...
            "final_production": get_final_production(),
            "outlets": get_outlets(),
